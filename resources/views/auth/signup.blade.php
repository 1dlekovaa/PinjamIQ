                        ...
                        <div class="col-md-6">
                            <div class="position-absolute w-40 top-0 start-0 h-100 d-md-block d-none">
                                <div class="oblique-image position-absolute d-flex fixed-top ms-auto h-100 z-index-0 bg-cover me-n8"
                                    ...
                                    <div class="my-auto text-start max-width-350 ms-7" style="position: relative; z-index: 2;">
                                        <h1 class="mt-3 text-white font-weight-bolder">Welcome to PinjamIQ</h1>
                                        <p class="text-white text-lg mt-4 mb-4">Sign up to explore smarter book management with PinjamIQ.</p>
                  
                                    </div>
                                    <div class="text-start position-absolute fixed-bottom ms-7" style="position: relative; z-index: 2;">
                                        <h6 class="text-white text-sm mb-5">Copyright © 2025 PinjamIQ Design System by XII PPLG 1.</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
