                        ...
                        <div class="col-md-6">
                            <div class="position-absolute w-50 top-0 end-0 h-100 d-md-block d-none">
                                <div class="oblique-image position-absolute d-flex fixed-top ms-auto h-100 z-index-0 bg-cover me-n8"
                                    ...
                                    <div class="my-auto text-start info-text ms-7" style="position: relative; z-index: 2;">
                                        <h1 class="mt-3 text-white font-weight-bolder">
                                            Your smart way to borrow and return books.
                                        </h1>
                                        <p class="text-white text-lg mt-3 mb-1">
                                            Where every book finds its reader.
                                        </p>
                                        <p class="text-white text-lg mt-2">
                                            Borrow smarter, read better, with <strong>PinjamIQ.</strong>
                                        </p>
                                    </div>

                                    <div class="text-start position-absolute fixed-bottom ms-7 mb-3" style="position: relative; z-index: 2;">
                                        <h6 class="text-white text-sm">
                                            Copyright © 2025 PinjamIQ Design System by XII PPLG 1.
                                        </h6>
                                    </div>
                                </div>
                            </div>
